...
class CrosswordEngineView {
    ...
    public function generate($meta = false) {
        ...
        if (get_option('crosswordengine_developer_mode')) {
            ...
            wp_enqueue_script( "crosswordengine-script", plugin_dir_url(__FILE__) . "../../dist/crosswordengine.jxword.js", [], "0.0.3", true );
        } else {
            wp_enqueue_style('crosswordengine-style', plugin_dir_url( __FILE__ ) . '../../dist/crosswordengine.jxword.min.css');
            wp_enqueue_script( "crosswordengine-script", plugin_dir_url(__FILE__) . "../../dist/crosswordengine.jxword.min.js", [], "0.0.3", true );
        }
