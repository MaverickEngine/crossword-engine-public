...
class CrosswordEngineView {
    ...
    public function generate($meta = false) {
        ...
        if (get_option('crosswordengine_developer_mode')) {
            wp_enqueue_style('crosswordengine-jxword-style', plugin_dir_url( __FILE__ ) . '../../dist/crosswordengine.jxword.css', [], "0.1.7");
            wp_enqueue_script( "crosswordengine-jxword-script", plugin_dir_url(__FILE__) . "../../dist/crosswordengine.jxword.js", [], "0.1.7", true );
        } else {
            wp_enqueue_style('crosswordengine-jxword-style', plugin_dir_url( __FILE__ ) . '../../dist/crosswordengine.jxword.min.css', [], "0.1.7");
            wp_enqueue_script( "crosswordengine-jxword-script", plugin_dir_url(__FILE__) . "../../dist/crosswordengine.jxword.min.js", [], "0.1.7", true );
        }
