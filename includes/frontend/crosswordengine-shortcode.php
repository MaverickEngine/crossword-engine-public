...
class CrosswordEngineShortcode {
    ...
    public function crosswordengine_shortcode($atts) {
        ...
        wp_enqueue_style('crosswordengine-style', plugin_dir_url( __FILE__ ) . '../../dist/crosswordengine.css');
        wp_enqueue_script( "crosswordengine-script", plugin_dir_url(__FILE__) . "../../dist/crosswordengine.js", [], "0.0.1", true );
