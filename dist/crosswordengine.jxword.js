...
class JXWord {
    constructor(opts) {
        ...
        this.opts = Object.assign({ 
            ...
            progress: 0,
            quartile: 0,
            completeAudio: "/wp-content/plugins/crossword-engine/dist/audio/crossword_ditty.mp3",
        }, opts);
        this.uid = +new Date();
        this.state = {
            time_taken: 0,
